 ...
 */
final class Version20241028071227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE math_topics (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, topic_name VARCHAR(20) DEFAULT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE math_topics');
